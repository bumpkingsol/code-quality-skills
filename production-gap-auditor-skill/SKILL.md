...
> **Detection patterns live in `references/patterns-by-language.md`** — load that file after
> Phase 1.2 has detected the stack so you can pull only the patterns relevant to this codebase.
